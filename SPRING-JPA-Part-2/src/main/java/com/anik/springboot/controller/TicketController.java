...
public class TicketController {
	...
	@GetMapping("/update")
	public String showUpdatePage(@RequestParam("ticketid") int ticketid , ModelMap model)
	{
	...
	@PostMapping("/update")
	public String updateTicket(@RequestParam("ticketId") int ticketid , @RequestParam("ticketname") String ticketname)
	{
		ticketDao.save(new Ticket(ticketid, ticketname));
		return "redirect:/view-tickets";
	}
